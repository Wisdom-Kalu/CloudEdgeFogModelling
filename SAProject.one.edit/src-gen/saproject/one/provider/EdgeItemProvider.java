...
/**
 * This is the item provider adapter for a {@link saproject.one.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider extends DataLocationItemProvider {
	/**
	...
	protected void addBalancerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Edge_balancer_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Edge_balancer_feature", "_UI_Edge_type"),
						OnePackage.Literals.EDGE__BALANCER, true, false, true, null, null, null));
	}
